...
setTimeout(function() {
	Java.perform(function() {
		...
		try{
			var checkEmulator = Java.use('com.google.firebase.crashlytics.internal.common.CommonUtils');
			checkEmulator.isRooted.implementation = function(){
				console.log('By pass Root');
				return false;
			}
		}catch{
			console.log('failed')
